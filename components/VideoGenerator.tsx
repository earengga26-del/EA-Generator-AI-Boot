...
const VideoGenerator: React.FC = () => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12">
      {/* Controls Panel */}
      <aside className="lg:col-span-3 bg-slate-800 p-4 border-r border-slate-700 overflow-y-auto">
          ...
          <fieldset disabled={isLoading} className="space-y-6 flex-grow">
            ...
            <div className="space-y-4">
              ...
              {scenes.map((scene, index) => (
                <div key={scene.id} className="bg-slate-900/50 p-3 rounded-lg border border-slate-700 relative space-y-2">
      ...
      {/* Content Area */}
      <main className="lg:col-span-9 bg-slate-900 p-4 md:p-8 overflow-y-auto">
        {error && (
