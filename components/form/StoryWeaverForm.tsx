...
const StoryWeaverForm: React.FC<SharedFormProps> = ({
    ...
    const handleGenerateSceneVideo = async (sceneId: string) => {
        ...
        try {
            ...
            const videoBlob = await fetch(`${downloadLink}&key=${usedApiKey}`).then(res => res.blob());
                ...
                <Card title="Panel Kontrol Story Weaver">
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <Select label="Rasio Aspek" id="aspectRatio" value={aspectRatio} onChange={e => setAspectRatio(e.target.value)}>
